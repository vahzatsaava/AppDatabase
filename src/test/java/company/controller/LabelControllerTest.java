...
public class LabelControllerTest extends TestCase{
    ...
    public void testCreateLabelTest_UnSuccessful() {
        Mockito.when(labelRepository.save(any())).thenReturn(new Label("Alfa"));
    ...
    public void testUpdate_Successful() {
        Mockito.when(labelRepository.update(any())).thenReturn(new Label("Alfa"));
    ...
    public void testGet_Successful() {
        Mockito.when(labelRepository.getById(1)).thenReturn(new Label("aaa"));
